...
const Page = () => {
  ...
  const [fullNameErrorMessege, setFullNameErrorMessege] = useState("");

  const handleFullName = (e) => {
    setFullName(e.target.value);
    setFullNameErrorMessege("");
  }
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (fullName === "") {
      setFullNameErrorMessege("Full Name is required");
    }
    else if (email === "") {
      ...
      <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
        ...
        >
          ...
          <p className="text-sm font-normal text-[#00334e] mb-10">
            Do not share with your Register information.
          </p>

          <div className="flex items-center border-2 border-[#00334e] border-opacity-50  py-2 px-3 rounded-2xl mb-4">
            <FaUserPen className="h-5 w-5 text-[#00334e] text-opacity-50"></FaUserPen>
            <input
              onChange={fullName}
          ...
          <div className="text-left ml-2 mt-3">
            ...
            Already have an account?
              <Link href="/login" className="text-[#ff9900] font-bold ml-[5px] ">
              Login Here
              </Link>
            </p>
          </div>
